...
export function AdminDashboardAnalytics() {
  const { totalCattle, totalBuffalo, predictionsToday, accuracyRate, monthlyPredictions, breedDistribution } =
    analyticsData
    ...
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      <Card className="shadow-lg">
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Total cattle records</p>
        </CardContent>
      </Card>
      <Card className="shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Total Buffalo</CardTitle>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="none"
        ...
        <CardContent>
          <div className="text-2xl font-bold">{totalBuffalo.toLocaleString()}</div>
          <p className="text-xs text-muted-foreground">Total buffalo records</p>
        </CardContent>
      </Card>
      <Card className="shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">+{predictionsToday}</div>
          <p className="text-xs text-muted-foreground">Predictions made today</p>
        </CardContent>
      </Card>
      <Card className="shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
